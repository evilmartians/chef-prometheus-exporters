...
listen_ip = node['network']['interfaces'][node['prometheus_exporters']['listen_interface']]['addresses'].find do |_address, data|
  data['family'] == 'inet'
end.first unless node['prometheus_exporters']['disable']
